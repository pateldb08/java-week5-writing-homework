...
public class Calculator {
    ...
    public void division(int a , int b){
        System.out.println("Division fo "+ a + " and " + b + "is:" + (a/b));
    }
    // method to calculat multiplicaion
    public void  multiplication(int a , int b ){
        System.out.println("Multiplicaion of " + a + " and " + b + "is:" + (a*b) );
    }
